...
<div id="banner_top">
	<img src="media/banner_geschichte.png" atl="text"/>
</div>
...
<div id="content" >
    ...
    <div id="content_left" style="height: 600px; overflow:auto;">
        <?php
            $html_buffer = '';
            $image_count = 0;
            $directory = './media/geschichte/';
            if (glob($directory . "*.jpg") != false) {
                $image_count = count(glob($directory . "*.jpg"));
            }
            for ($i=1; $i <= $image_count; $i++) {
                $html_buffer .= '
                <img src="media/geschichte/geschichte_'.$i.'.jpg" alt="Alte Schule Gaertringen" style="margin-bottom: 12px"/>';
            }
            echo $html_buffer;
        ?>
